                    ...
                    <form>
                      <div class="form_group row">
                        ...
                        <div class="input_group col-xl-10 col-lg-9 col-12">
                          <input class="white_input_text" type="text" name="title" placeholder="Category Name" value="people">
                        </div>
                      </div>
                      <div class="form_group row">
                        <div class="col-xl-2 col-lg-3 col-12">
                        ...
                        <div class="input_group col-xl-10 col-lg-9 col-12">
                          <input class="white_input_text" type="text" name="c_slug" placeholder="Category Slug" value="people">
                        </div>
                      </div>
                      <div class="form_group row">
                        <div class="col-xl-2 col-lg-3 col-12">
                        ...
                        <div class="input_group col-xl-10 col-lg-9 col-12">
                          <textarea class="white_input_text" name="c_desc">A variety of situations in which people are the main actors</textarea>
                        </div>
                      </div>
                      <div class="button_group row">
                        ...
                        <div class="input_group col-xl-10 col-lg-9 col-12">
                          <button class="dashboard_button category_submit" type="submit">Update</button>
                        </div>
                      </div>
                    </form>
                  </div>
