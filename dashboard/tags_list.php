                  ...
                  <div class="row">
                     <div class="col-lg-9 col-md-8 col-12">
                      ...
                      <div class="col-lg-3 col-md-4 col-12 search_right_side">
                        <a href="add_tags.php" class="dashboard_button">Add Tags</a>
                      </div>
                    </div>
               </div>
               <!-- Searchbar End -->
                  ...
                  <div class="gif_dasboard_table table-responsive">
                    <table class="table dashboard_data_table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>man<span class="n_count">(851)</span></td>
                          <td>man</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>cat<span class="n_count">(689)</span></td>
                          <td>cat</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>dog<span class="n_count">(613)</span></td>
                          <td>dog</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>crazy<span class="n_count">(589)</span></td>
                          <td>crazy</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>parody<span class="n_count">(534)</span></td>
                          <td>parody</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>fail<span class="n_count">(534)</span></td>
                          <td>fail</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>car<span class="n_count">(534)</span></td>
                          <td>car</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>boy<span class="n_count">(534)</span></td>
                          <td>boy</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
                        ...
                        <tr>
                          <td>edu<span class="n_count">(534)</span></td>
                          <td>edu</td>
                          <td class="tbl_action_btns">
                            <a href="#" class="a_icon"><i class="fas fa-pen"></i></a>
                            <a href="#" class="a_icon"><i class="far fa-trash-alt"></i></a>
