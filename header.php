...
<html lang="en">
<head>
    <title>GifGifMagazine</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
    <meta name="description" content="GifGifMagazine">
    <meta name="Keyword" content="Gif, gifs, gifgif, funny,">
    ...
    <!-- plugins css -->
    <link href="assets/css/style.css?ver=2.8" rel="stylesheet">
    <link href="assets/css/responsive.css?ver=2.8" rel="stylesheet">
...
<body>
        ...
        <div class="container">
            <div class="header_container">
                <div class="row"> 
                    ...
                    <div class="col-lg-10 col-sm-8 col-8 hdr_col_right">
                        <div class="header_right_dv">
                            <!-- Navigation --> 
    ...
    <!-- header End -->
    <!-- Sidebar Menu Start-->
    <div class="sidebar_fix_menu">
        <div class="sidebar_fix_menu_body">
            ...
            <nav class="gif_sidebar_navs">
                ...
                <!-- show in mobile -->
                <ul>
                    <li><a href="dashboard/add_gif.php">Add gif</a></li>
