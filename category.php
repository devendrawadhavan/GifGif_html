    ...
    <div class="sections gf_asside_wrapper gif_category_pages">
        <div class="container">
            <!-- Advertisement Div -->
                ...
                <div class="col-xl-8 col-lg-8 col-12">
                    <div class="h_gif_grid_container">
                        <div class="gif_cate_page_heading">
                            ...
                            <p>Gifs with animals: cat, dog, horse, cow, turtles, goats, frog, monkey, birds and many funny gifs with animals that can be found in this category</p>
                        </div>
                        <div class="row">
